...
const colors = {
  ...
  mapx: '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:#176b50] [--checkbox-checked-border:#12513f] group-data-focus:outline-[#176b50] dark:[--checkbox-checked-bg:#2a8063] dark:[--checkbox-checked-border:#4b9a7d]',
