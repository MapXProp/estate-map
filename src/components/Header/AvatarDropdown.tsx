    ...
    <div className={className}>
      <Popover>
        ...
        <PopoverPanel
          ...
          className="z-40 w-80 max-w-[calc(100vw-1rem)] rounded-3xl shadow-lg ring-1 ring-black/5 transition duration-200 ease-in-out data-closed:translate-y-1 data-closed:opacity-0"
        >
