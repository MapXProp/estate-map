...
export default function ListingMediaUpload({ kind, count, limit, isThai, disabled, onChange }: Props) {
  ...
  return (
    <label
      ...
      className={`relative flex min-h-24 items-center gap-3 rounded-2xl border border-dashed p-3 transition focus-within:ring-2 focus-within:ring-[#176b50]/40 sm:p-4 ${unavailable ? 'cursor-default border-neutral-200 bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-950' : 'cursor-pointer border-neutral-300 bg-neutral-50/60 hover:border-[#176b50] hover:bg-emerald-50/40 dark:border-neutral-600 dark:bg-neutral-950 dark:hover:border-emerald-600'}`}
    >
