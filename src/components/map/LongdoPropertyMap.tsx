  ...
  return (
    ...
    >
      <style>{`
        ...
        .mapx-project-label::after { content: ''; position: absolute; width: 6px; height: 6px; background: inherit; border-style: solid; border-color: inherit; border-width: 0 1px 1px 0; pointer-events: none; }
        .mapx-project-marker[data-mapx-project-placement="top"] .mapx-project-label::after { left: 50%; bottom: -4px; transform: translateX(-50%) rotate(45deg); }
        .mapx-project-marker[data-mapx-project-placement="right"] .mapx-project-label::after { top: 50%; left: -4px; transform: translateY(-50%) rotate(135deg); }
        .mapx-project-marker[data-mapx-project-placement="left"] .mapx-project-label::after { top: 50%; right: -4px; transform: translateY(-50%) rotate(-45deg); }
        .mapx-project-marker[data-mapx-project-placement="bottom"] .mapx-project-label::after { left: 50%; top: -4px; transform: translateX(-50%) rotate(225deg); }
