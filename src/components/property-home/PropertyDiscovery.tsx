...
const channelCategories: Record<DiscoveryChannelCode, DiscoveryCategory[]> = {
  ...
  rooms: [
    { type: 'rental_room', th: 'ห้องเช่า', en: 'Rental rooms', icon: KeyRound, tone: 'sky', image: 'rental-room' },
    { type: 'apartment', th: 'อพาร์ตเมนต์', en: 'Apartments', icon: Building, tone: 'slate', image: 'apartment' },
    { type: 'dormitory', th: 'หอพัก', en: 'Dormitories', icon: GraduationCap, tone: 'sand', image: 'dormitory' },
    { type: 'condo', th: 'คอนโดเช่า', en: 'Condo rentals', icon: Building2, tone: 'green', image: 'condo' },
    { type: 'flat', th: 'แฟลต', en: 'Flats', icon: DoorOpen, tone: 'rose', image: 'flat' },
    {
      type: 'monthly_hotel',
      th: 'โรงแรมรายเดือน',
      en: 'Monthly hotels',
  ...
  business: [
    ...
    { type: 'office', th: 'ออฟฟิศ', en: 'Offices', icon: PanelsTopLeft, tone: 'sky', image: 'office' },
    { type: 'warehouse', th: 'โกดัง', en: 'Warehouses', icon: Warehouse, tone: 'sand', image: 'warehouse' },
    { type: 'factory', th: 'โรงงาน', en: 'Factories', icon: Factory, tone: 'slate', image: 'factory' },
    { type: 'shophouse', th: 'ตึกแถว', en: 'Shophouses', icon: Building, tone: 'orange', image: 'shophouse' },
    { type: 'home_office', th: 'โฮมออฟฟิศ', en: 'Home offices', icon: House, tone: 'sky', image: 'home-office' },
    { type: 'land', th: 'ที่ดิน', en: 'Land', icon: LandPlot, tone: 'green', image: 'land' },
  ],
}
...
const channelContent = {
  homes: {
    ...
    placeholderTh: 'ค้นหาย่าน ถนน หรือสถานที่',
    placeholderEn: 'Search area, road or place',
